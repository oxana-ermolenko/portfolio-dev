import { contact } from "@/lib/common/data";

export interface IContact {}

const Contact: React.FC<IContact> = () => {
  return (
    <section className="section dark:bg-primary" id="contact">
        ...
        <div className="flex flex-col lg:gap-x-8 lg:flex-row">
          ...
          <form className="space-y-8 w-full max-w-[780px]">
            <div className="flex gap-8">
              <input className="input bg-paragraph" type="text" placeholder="Your name" />
              <input className="input bg-paragraph" type="email" placeholder="Your email" />
            </div>
            <input className="input bg-paragraph" type="text" placeholder="Subject" />
            <textarea className="textarea bg-paragraph" placeholder="Your message"></textarea>
